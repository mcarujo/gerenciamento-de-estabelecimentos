        ...
        <div id="main">
          <div class="content">
            ...
            <p>
              ...
              (Docker) é o branch responsável por iniciar os dois micro
              serviços, front-end e back-end. Dentro dele você vai encontrar
              dois 'Dockerfile' nos diretórios 'back-end' e 'front-end'. Ambos
              criam o ambiente para execução dos seus respectivos serviços.
            </p>
            ...
            <p>
              ...
              do{" "}
              <a href="https://www.eduardopires.net.br/2013/04/orientacao-a-objeto-solid/">
                SOLID
              </a>
